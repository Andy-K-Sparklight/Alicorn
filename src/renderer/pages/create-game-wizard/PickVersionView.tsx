...
export function PickVersionView() {
    ...
    const versions = manifest?.versions?.filter(v => includeSnapshot || v.type !== "snapshot");
                ...
                <div className="flex flex-col h-full gap-4">
                    ...
                    <div className="text-sm text-foreground-500">
                        <Trans
                            ...
                            i18nKey="hint"
                            components={[
                                <Link className="text-sm" key="it" onPress={selectLatest} />,
                            ]}
                        />
                    </div>
...
function VersionContent({ version: { id, type, sha1, releaseTime } }: { version: VersionEntry }) {
    ...
    return (
        <div className="flex h-[48px] items-center gap-4 py-1">
