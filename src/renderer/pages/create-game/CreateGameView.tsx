...
export function CreateGameView({ params: { gameId } }: PropsWithParams<{ gameId?: string }>) {
    ...
    const [gameVersion, setGameVersion] = useState<string | undefined>(
        (profile?.installProps as any)?.gameVersion || "",
    );
    const [containerId, setContainerId] = useState<string | undefined>(
        profile?.launchHint.containerId,
    );
    ...
    return (
        <div className="w-11/12 h-full mx-auto overflow-y-auto overflow-x-hidden">
            <div className="mx-4">
                ...
                <div className="w-full grow flex flex-col gap-6 mt-4">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        {["fabric", "quilt", "neoforged", "forge", "rift", "optifine"].includes(
                            installType,
                        ) && (
